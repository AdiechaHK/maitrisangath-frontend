    ...
    <div class="conteiner">
        ...
        <div class="row">
            ...
            <div class="col-md-9 text-left">
                ...
                <h4> {{ thisrule.description || $t('sections.articles.no_description')}} </h4>
                <!-- 
...
export default {
  ...
  async created() {
    try {
      const res = await axios.get('https://raw.githubusercontent.com/AdiechaHK/maitrisangath-data/master/articles.json');
      console.log(res);
      if (res.status == 200) {
